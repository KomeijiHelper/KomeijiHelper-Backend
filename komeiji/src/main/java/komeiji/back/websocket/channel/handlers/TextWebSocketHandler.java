...
//        for(SessionToken token: WebSocketServer.getWebSocketSingleServer().getSessionManager().getSessions().keySet()) {
//            Utils.getSessionManager().findSession(token).getConnect()
